...
class ViewDownloadedVideo extends StatefulWidget {
  final String? vidPath;
  const ViewDownloadedVideo({super.key, this.vidPath});

  @override
  State<ViewDownloadedVideo> createState() => _ViewDownloadedVideoState();
}

class _ViewDownloadedVideoState extends State<ViewDownloadedVideo> {
