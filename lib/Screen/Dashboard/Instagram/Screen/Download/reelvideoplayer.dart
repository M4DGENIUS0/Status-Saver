...
class PlayDownloadedReels extends StatefulWidget {
  final String? vidPath;
  const PlayDownloadedReels({super.key, this.vidPath});

  @override
  State<PlayDownloadedReels> createState() => _PlayDownloadedReelsState();
}

class _PlayDownloadedReelsState extends State<PlayDownloadedReels> {
  ...
  void initState() {
    ...
    _chewieController = ChewieController(
      ...
      materialProgressColors: ChewieProgressColors(
        playedColor: assets.instgramColor4.withOpacity(0.5),
        handleColor: assets.instgramColor4,
