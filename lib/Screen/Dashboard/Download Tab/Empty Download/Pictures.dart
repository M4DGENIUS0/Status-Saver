...
class EmptyBucketPicturesTab extends StatelessWidget {
  const EmptyBucketPicturesTab({super.key});
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      children: [
        ...
        Icon(Icons.photo_library, color: Colors.grey[600],size: 100,),
        const SizedBox(height: 10,),
        Text(
          AppLocalizations.of(context)!.no_saved_available,
          style: TextStyle(
